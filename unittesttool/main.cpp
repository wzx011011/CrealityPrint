...
int main(int argc, char* argv[]) {
...
#endif
  QCoreApplication::setOrganizationName(QStringLiteral("Creality"));
  ...
  engine.rootContext()->setContextProperties({
	...
	{ QStringLiteral("unittool_vld_enabled"), QVariant::fromValue(true) },
	#endif
    { QStringLiteral("unittool_vld_enabled"), QVariant::fromValue(false) },
#endif
  });
