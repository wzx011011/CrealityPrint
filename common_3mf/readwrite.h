...
namespace common_3mf
{
	...
	public:
		...
		bool read_all_3mf(Scene3MF& scene, bool use_escaping=false,ccglobal::Tracer* tracer = nullptr);
    ...
    protected:
        ...
        void _extract_slice_info_from_archive(mz_zip_archive& archive, const mz_zip_archive_file_stat& stat);
    ...
    public:
        ...
        void append_file(const std::string& file_name, const std::string& entry_name);
    protected:
