...
namespace cxkernel
{
    ...
    bool saveFile(qtuser_core::CXHandleBase* handler, const QString& defaultName, const QString& title, const QString& filter)
    {
        bool res = cxKernel->ioManager()->save(handler, defaultName, title, filter);
        return res;
    }
