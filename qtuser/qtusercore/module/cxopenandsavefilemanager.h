...
namespace qtuser_core
{
	...
	public:
		...
		bool save(CXHandleBase* receiver = nullptr, const QString& defaultName = QString(""), const QString& title = QString(""), const QString& filter = QString(""));
	...
	QTUSER_CORE_API bool dialogSave(const QString& filter, const QString& defaultName, const QString& title, saveFunc func);
}
