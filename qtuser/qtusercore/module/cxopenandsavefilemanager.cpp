...
namespace qtuser_core
{
	...
	bool CXFileOpenAndSaveManager::save(CXHandleBase* receiver, const QString& defaultName, const QString& title, const QString& filter)
	{
		...
		else
		{
			...
			res = dialogSave(filter.isEmpty() ? generateFilterFromHandlers(true) : filter,
...
//		func(fileName);
//	}
	bool dialogSave(const QString& filter, const QString& defaultName, const QString& title,saveFunc func)
	{
		if (!func)
			return false;
		qtuser_core::VersionSettings setting;
