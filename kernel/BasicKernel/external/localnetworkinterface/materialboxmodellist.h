...
public:
	...
	Q_INVOKABLE QObject* getGroupHumidityItem(const int groupIndex);
	...
	Q_PROPERTY(int materialCount	READ getMaterialCount  NOTIFY materialCountChanged)
