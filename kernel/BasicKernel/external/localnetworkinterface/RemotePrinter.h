...
{
	enum UploadStatus {
            UPLOAD_STATUS_PENDING = Qt::UserRole + 1,
	...
	float machineHeight=0;
	float machineWidth=0;
	float machineDepth=0;
	...
	int feedState;
	int cfsConnect;
	UploadStatus uploadStatus = UploadStatus::UPLOAD_STATUS_CANCELED;
	QList<RemoteMaterial> remoteMaterial;
	QList<GcodeFile> remoteFileList;
	long long remoteFileUpdateTime = 0;
