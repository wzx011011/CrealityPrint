...
namespace creative_kernel
{
	...
	public:
		...
		void uploadFile(RemotePrinter& printer, const std::string& fileName, const std::string& filePath, std::function<void(std::string, std::string, float)> callback, std::function<void(std::string, std::string, int)> errorCallback = nullptr);
		void cancelUploadFile(QString printerIp);
	...
	private:
		...
		QMap<QString, RemotePrinter*> m_mapUploadsStatus;
