...
namespace creative_kernel
{
	...
	std::future<void>  KlipperInterface::sendFileToDevice(const std::string& strServerIp, const int& port, std::string fileName, std::string filePath, std::function<bool(float)> callback, std::function<void(int)> errorCallback)
	{
