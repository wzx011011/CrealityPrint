...
#define OLD_PROJECT_NAME "E-Tech"
namespace creative_kernel
{
	...
	void PreferenceManager::setDownloadModelPath(const QUrl path)
	{
		m_lastModelPath = m_downloadModelPath;
		m_downloadModelPath = path.toLocalFile();
		setSettingValue("download_model_path", m_downloadModelPath);
