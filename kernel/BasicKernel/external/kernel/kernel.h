...
namespace creative_kernel
{
	...
	public:
		...
		virtual void processCrealink(const QString& link) override;
		int currentPhase();
		bool isDefaultVisScene();
		QString crealityPrinterLink() const { return m_crealityPrinterLink; }
		...
		Q_INVOKABLE bool is3MFProject(QString filePath);
		Q_INVOKABLE bool isPrintabled3MF(QString filePath);
		Q_INVOKABLE QString convertUrlToLocalPath(const QString& urlString)
		{
			QUrl url(urlString);
