...
namespace creative_kernel
{
    ...
    void CX3DExporterCommand::execute()
    {
        ...
        cxkernel::saveFile(nullptr, prjectName, QCoreApplication::translate("CustomObject", "Save Project As"));
    }
    ...
    bool CX3DExporterCommand::exportGcode3mf(const QString defaultName, QList<int> plateIds)
    {
        m_plateIds = plateIds;
        bool res = cxkernel::saveFile(this, defaultName, QCoreApplication::translate("creative_kernel::Save3MFCommand", "Save 3MF"), "3MF files(*.3mf)");
        return res;
    }
