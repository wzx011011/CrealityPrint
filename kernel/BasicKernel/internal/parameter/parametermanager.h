...
namespace creative_kernel
{
    ...
    class ParameterManager : public QObject
    {
        ...
        Q_PROPERTY(bool isCrealityMachine READ isCrealityMachine NOTIFY curMachineIndexChanged);
    ...
    public:
        ...
        void loadProjectSettings(const QString& filename,std::vector<float>& wipe_tower_x,std::vector<float>& wipe_tower_y,bool& bOfficial);
    ...
    protected:
        ...
        void _addMachine(PrintMachine *machine,bool keepSettings = false);
        void _addImportMachine(PrintMachine *machine);
        void _addMachineFromUniqueName(const QString &uniqueName,bool keepSettings = false);
    ...
    private:
        ...
        void syncExtruder(PrintMachine* newMachine, PrintMachine* oldMachine);
    private:
