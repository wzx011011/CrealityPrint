...
namespace creative_kernel
{
	...
	class BASIC_KERNEL_API Printer : public QObject, public SpaceTracer
	{
		Q_OBJECT
			...
			Q_PROPERTY(QObject* settingsObject READ settingsObject NOTIFY signalSettingsChanged)
	...
	public:
		...
		*/
		...
		void applySettings(QSharedPointer<us::USettings> settings);
