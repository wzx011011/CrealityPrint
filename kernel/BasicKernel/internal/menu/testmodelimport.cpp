...
namespace creative_kernel
{
    ...
    Q_INVOKABLE void TestModelImport::execute()
    {
        ...
        case creative_kernel::TestModelImport::SQUARE_PRISM_Z_AXIS:
            ...
            break;
        case creative_kernel::TestModelImport::CREALITY_LOGO:
            fileName = "creality_logo%1.stl";
            break;
        default:
            break;
        }
        ...
        #endif
        if(creative_kernel::TestModelImport::CREALITY_LOGO == m_ShapeType)
        {
            for(int i = 1; i < 4; i++)
            {
                QString filename = name.arg(i);
                openSpecifyMeshFile(filename);
            }
    ...
    void TestModelImport::setActionNameByType(ShapeType type)
    {
        ...
        case creative_kernel::TestModelImport::OVERHANG:
            ...
            break;
        case creative_kernel::TestModelImport::CREALITY_LOGO:
            m_actionname = QCoreApplication::translate("TestModel", "Creality Logo");
            m_actionNameWithout = "Creality Logo";
            m_source = "qrc:/UI/photo/menuImg/LOGO.png";
            m_icon = "qrc:/UI/photo/menuImg/LOGO.png";
            break;
        case creative_kernel::TestModelImport::SQUARE_COLUMNS_Z_AXIS:
