...
#define NOT_GENERATE_TIMELAPSE                                      "not_generate_timelapse"
    ...
    struct GCodeProcessorResult
    {
        ...
        // creality
        std::vector<std::string> creality_fliament_types;   //default_filament_type  
        std::vector<std::string> creality_extruder_colors;  //default_filament_colour
        std::vector<std::string> creality_extruder_colors_with_unused;  //default_filament_colour
        std::vector<std::string> creality_complete_extruder_colors; //filament_type
        ...
        std::vector<std::pair<int, std::vector<unsigned char>>> image_data;
        ...
        GCodeProcessorResult& operator=(const GCodeProcessorResult &other)
        {
            ...
            // creality
            creality_fliament_types = other.creality_fliament_types;
            creality_extruder_colors = other.creality_extruder_colors;
            creality_extruder_colors_with_unused = other.creality_extruder_colors_with_unused;
    ...
    private:
        ...
        std::vector<std::string> image_data_cache;
    ...
    private:
        ...
        bool process_orca_tags(const std::string_view comment);
