...
BasicDialog {
    ...
    property var connectedDevice: MachineManager.printerOutputDevices.length >= 1 ? MachineManager.printerOutputDevices[0] : null
    ...
    titleBackground: "#6E6E73"
    contentBackground: "#4B4B4D"
                ...
                ColumnLayout {
                    ...
                    Row {
                        ...
                        BasicDialogTextField {
                            ...
                            width: 121
                            text: ""
                            defaultBackgroundColor: "#4B4B4D"
                            itemBorderColor: "#6E6E72"
                            radius: 5
                            onAccepted: {
                    ...
                    Row {
                        ...
                        StyledLabel {
                            text: activePrintJob != null ? getPrettyTime(activePrintJob.timeTotal) : ""
                            anchors.verticalCenter: parent.verticalCenter
                            color: "white"
                            font.pixelSize: 12
                            width: 160
