                    ...
                    delegate: Rectangle {
                        ...
                        Menu {
                            ...
                            Action {
                                ...
                                enabled: (curTransProgress <= 0 && curTransProgress!=-3) || curTransProgress == 100
                                onTriggered: {
...
//                                                        errorMsgTxt.text = qsTr("Description:")+(ErrorData.errorJson[errorKey]?ErrorData.errorJson[errorKey].content: qsTr("Unknown exception"))
                            ...
                            ColumnLayout {
                                ...
                                RowLayout {
                                    ...
                                    Text {
                                        Layout.preferredWidth: contentWidth * screenScaleFactor
                                        Layout.preferredHeight: 14 * screenScaleFactor
                                        visible: (curTransProgress >= 0) || curTransProgress == -3
                                        font.weight: Font.Medium
                                        font.family: Constants.mySystemFont.name
                                        font.pointSize: Constants.labelFontPointSize_9
                                        verticalAlignment: Text.AlignVCenter
                                    ...
                                    Item {
                                        ...
                                        Text {
                                            ...
                                            property var idleModelName: (curTransProgress > 0 && curTransProgress < 100) || curTransProgress==-3 ? curGcodeFileName : " "
                                            ...
                                            property var showProcessText: "<br>" + "<font color='#0AF545'>" + qsTranslate("Cpr_ErrorMsg", transErrorMessage) + "</font>"
                                            anchors.fill: parent
                                            font.weight: Font.Medium
                                            font.family: Constants.mySystemFont.name
                                            font.pointSize: Constants.labelFontPointSize_9
                                            ...
                                            color: sourceTheme.text_light_color
                                            elide: Text.ElideMiddle
                                            text: (curTransProgress <0) ? (curTransProgress==-1?showErrorText:showProcessText) : realGcodeName
                                ...
                                RowLayout {
                                    spacing: 10 * screenScaleFactor
                                    visible: (curTransProgress != 0) && curTransProgress != 100 //rootItem.isDeviceIdle//空闲页面传输中
                                    ...
                                    CusButton {
                                        ...
                                        Layout.preferredWidth: 14 * screenScaleFactor
                                        Layout.preferredHeight: 14 * screenScaleFactor
                                        visible: (curTransProgress>1 && curTransProgress<100) || curTransProgress==-3
                                        color: isHovered ? "#FF365C" : "#B53048"
                                        //borderWidth: 1
                                        //borderColor: isHovered ?  (Constants.currentTheme ? "#AAAAB0": "#505052") : Constants.themeGreenColor
                                        Image {
                                            anchors.centerIn: parent
                                        ...
                                        onClicked: mItem.cancelUploadFile()
                                    }
    ...
    Row {
        ...
        Button {
            width: 200 * screenScaleFactor
            height: 36 * screenScaleFactor
            visible: realEntry && oneClickPrintAble && curGcodeFileName.endsWith(".gcode")
            onClicked: {
