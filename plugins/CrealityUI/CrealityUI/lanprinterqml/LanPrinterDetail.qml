...
Rectangle {
    ...
    property string noBoxPrinter2: "qrc:/UI/photo/lanPrinterSource/noBoxPrinter2.png"
    ...
    property var webrtcSupport: deviceItem ? deviceItem.webrtcSupport : 0
                ...
                ColumnLayout {
                    ...
                    CusRoundedBg {
                        ...
                        ColumnLayout {
                            ...
                            Timer {
                                property var target
                                property var targetPos: 0.0
                                property var trycnt: 0
                                id: oneShotTimer
                                interval:  1000
                                repeat: true
                                function reset(){
                                ...
                                onTriggered: {
                                    console.warn("control enabled: target="+target)
                                    trycnt++
                                    
                                    if(target == "idZHome")
                                    {
                                        var zPos = parseFloat(idZPostion.text)
                                        if(targetPos.z == zPos){
                                            if(trycnt > 0)
                                                trycnt = -5
                                        ...
                                        if(trycnt > 60|| trycnt ==0){
                                            oneShotTimer.stop()
                                            root.controlEnabled = true
                                            //console.warn("control failed:"+trycnt)
                                            //idWarningText.text = "TimerOut! Please retry"
                                            return
                                        }
                                    }else if(target == "idXYHome")
                                    {
                                        var xPos = parseFloat(idXPostion.text)
                                        var yPos = parseFloat(idYPostion.text)
                                        
                                        if(targetPos.x == xPos && targetPos.y == yPos){
                                            if(trycnt > 0)
                                                trycnt = -5
                                            
                                        }else{
                                            if(xPos < 20 && yPos < 20)
                                                targetPos = {x:xPos, y:yPos}
                                           
                                        }
                                        console.warn("control enabled: targetPos="+targetPos+" trycnt="+trycnt)
                                        if(trycnt > 30 || trycnt ==0){
                                            oneShotTimer.stop()
                                            root.controlEnabled = true
                                            //console.warn("control failed:"+trycnt)
                                            //idWarningText.text = "TimerOut! Please retry"
                                        ...
                                        var curPos = parseFloat(target.text)

                                        if(trycnt > 20 || Math.abs(curPos - targetPos) <= 0.1){
                                            oneShotTimer.stop()
                                            root.controlEnabled = true
                                            if(trycnt > 20){
                                                console.warn("control failed:"+curPos+"->"+targetPos+":"+trycnt)
                                                idWarningText.text = "TimerOut! Please to reset home position"
                                                return
                                            }
                                            return
                                        }
                                ...
                                GridLayout {
                                    ...
                                    Rectangle {
                                        ...
                                        MouseArea {
                                            ...
                                            onClicked: {
                                                ...
                                                idWarningText.text = qsTr("")
                                                if(targetValue > deviceItem.machineDepth){
                                                    idWarningText.text = qsTr("The Y axis is at the limit position")
                                                    return
                                                }
                                                oneShotTimer.reset()
                                                oneShotTimer.targetPos = targetValue
                                                oneShotTimer.target = idYPostion
                                        ...
                                        MouseArea {
                                            ...
                                            onClicked: {
                                                ...
                                                if(deviceItem && deviceItem.machinePlatformMotionEnable)
                                                {
                                                    ...
                                                    targetValue  =parseFloat(idZPostion.text) + curUnit
                                                    targetCmd = `Z${curUnit} F600`
                                                    targetValueLimit = targetValue > deviceItem.machineHeight

                                                }

                                                if(targetValueLimit){
                                                    idWarningText.text = qsTr("The Z axis is at the limit position")
                                                    return
                                                }
                                                oneShotTimer.reset()
                                                oneShotTimer.targetPos = targetValue
                                                oneShotTimer.target = idZPostion
                                    ...
                                    Rectangle {
                                        ...
                                        MouseArea {
                                            ...
                                            onClicked: {
                                                ...
                                                idWarningText.text = qsTr("")
                                                if(targetValue < 0){
                                                    idWarningText.text = qsTr("The X axis is at the limit position")
                                                    return
                                                }
                                                var postion = isKlipper_4408 ? `X-${curUnit} F3000` : targetValue
                                                oneShotTimer.reset()
                                                oneShotTimer.targetPos = targetValue
                                                oneShotTimer.target = idXPostion
                                    ...
                                    Rectangle {
                                        ...
                                        MouseArea {
                                            ...
                                            onClicked: {
                                                oneShotTimer.reset()
                                                oneShotTimer.targetPos = {x:0, y:0}
                                                oneShotTimer.target = "idXYHome"
                                    ...
                                    Rectangle {
                                        ...
                                        MouseArea {
                                            ...
                                            onClicked: {
                                                ...
                                                var targetValue = parseFloat(idXPostion.text) + curUnit
                                                idWarningText.text = qsTr("")
                                                if(targetValue > deviceItem.machineWidth){
                                                    idWarningText.text = qsTr("The X axis is at the limit position")
                                                    return
                                                }
                                                oneShotTimer.reset()
                                    ...
                                    Rectangle {
                                        ...
                                        MouseArea {
                                            ...
                                            onClicked: {
                                                oneShotTimer.reset()
                                                oneShotTimer.targetPos = {z:0}
                                                oneShotTimer.target = "idZHome"
                ...
                ColumnLayout {
                    ...
                    CusRoundedBg {
                        ...
                        FileDialog {
                            ...
                            nameFilters: ["All files(*.gcode *.3mf)"]
                            fileMode : FileDialog.OpenFiles
                            options: if(Qt.platform.os == "linux") return FileDialog.DontUseNativeDialog
                            property string fileName: ""
                            onAccepted: {
                                var fileUrls = fileDialog.files
                                var availableFileUrls = []
                                var invalidFileUrls = []
                                if(deviceID !== "" && fileUrls.length)
                                {
                                    for(var i = 0; i < fileUrls.length; i++)
                                    {
                                        var isAvailableFile = fileUrls[i].endsWith(".gcode") || kernel_kernel.isPrintabled3MF(fileUrls[i])
                                        if(isAvailableFile)
                                            availableFileUrls.push(fileUrls[i])
                                        else
                                            invalidFileUrls.push(fileUrls[i].substring(10))
                                    }
                                    //提示用户导入的文件不支持
                                    if(invalidFileUrls.length>0){
                                        if(fileUrls.length == 1)
                                        {
                                            idMessageDialog.showMessageDialog(LanPrinterDetail.MessageType.InvalidFile)
                                            idMessageDialog.ipAddress = ipAddress
                                            idMessageDialog.deviceType = deviceType
                                        }else{
                                            idMessageDialog.showMessageDialog(LanPrinterDetail.MessageType.InvalidFiles)
                                            idMessageDialog.height = idMessageDialog.height + 15 * invalidFileUrls.length
                                            idMessageDialog.curMessageText = idMessageDialog.curMessageText+"\n"+invalidFileUrls.join("\n")
                                            idMessageDialog.ipAddress = ipAddress
                                            idMessageDialog.deviceType = deviceType
                                        }

                                    }
                                    printerListModel.cSourceModel.importFile(deviceID, availableFileUrls)
                            ...
                            RowLayout{
                                ...
                                Text{
                                    ...
                                    text: {
                                        ...
                                        case LanPrinterDetail.ListViewType.GcodeListView:
                                            return qsTr("Selected files")+":"+ deviceItem.gcodeFileListModel.cSourceModel.gcodeFileSelectedCount+ "/" + deviceItem.gcodeFileListModel.cSourceModel.rowsCount
                                        case LanPrinterDetail.ListViewType.HistoryListView:
                                            return qsTr("Selected files")+":"+ historyFileListModel.historyFileSelectedCount+"/" +historyFileListModel.rowsCount
                                        case LanPrinterDetail.ListViewType.VideoListView:
                                            return qsTr("Selected files")+":"+ videoListModel.videoFileSelectedCount+"/" +videoListModel.rowsCount
                                        }
                                    }
                                }
                                Item {
                                ...
                                Rectangle {
                                    ...
                                    MouseArea {
                                        ...
                                        onClicked: {
                                            let idx = idSwipeview.currentIndex
                                            if(idx === LanPrinterDetail.ListViewType.GcodeListView
                                                    || idx === LanPrinterDetail.ListViewType.VideoListView){
                                                    ...
                                                    Rectangle {
                                                        ...
                                                        MouseArea {
                                                            ...
                                                            onClicked:
                                                            {
                                                                ...
                                                                if(fileListModel.length === 0)
                                                                {
                                                                    console.log("fileListModel.length === 0")
                                                                    idMessageDialog.showMessageDialog(LanPrinterDetail.MessageType.InvalidFile)
                                                                    idMessageDialog.ipAddress = ipAddress
                                                                    idMessageDialog.deviceType = deviceType
                                                                    return
                                                    ...
                                                    Rectangle {
                                                        ...
                                                        MouseArea {
                                                            ...
                                                            onClicked:
                                                            {
                                                                ...
                                                                if(gcodeFileName.toLowerCase().endsWith(".3mf"))
                                                                    saveGcodeDialog.nameFilters = ["3mf files (*.3mf)", "All files (*)"]
                                                                else
                                                                    saveGcodeDialog.nameFilters = ["Gcode files (*.gcode)", "All files (*)"]
                                                ...
                                                Item {
                                                    ...
                                                    RowLayout {
                                                        ...
                                                        Image {
                                                                ...
                                                                fillMode: Image.PreserveAspectFit
                                                                sourceSize: Qt.size(width, height)
                                                                source: modelItemImagePrefix + gCodeThumbnailImage + "?t=" + gcodeTime
                                                                ...
                                                                Popup {
                                                                    ...
                                                                    onVisibleChanged:{
                                                                        ...
                                                                        if (visible) {
                                                                            ...
                                                                            console.log(gCodeThumbnailImageId.status)
                                                                            if(gCodeThumbnailImageId.status == Image.Error)
                                                                            {
                                                                                gCodeThumbnailImageId.source="";
                                                                                gCodeThumbnailImageId.source= modelItemImagePrefix + gCodeThumbnailImage
                                                                            }
                                                                        }else{
                                                ...
                                                Item {
                                                    ...
                                                    RowLayout {
                                                        ...
                                                        Image {
                                                            ...
                                                            fillMode: Image.PreserveAspectFit
                                                            sourceSize: Qt.size(width, height)
                                                            source: "http://" + ipAddress + "/downloads/humbnail/" + encodeURIComponent(gcodeFileName.substring(0, gcodeFileName.lastIndexOf('.')) + ".png")
                                                        }
                            ...
                            Item{
                                ...
                                Canvas{
                                    ...
                                    Connections {
                                        ...
                                        onExcludedObjectsChanged: {
                                            //console.log("printArr connect changed:",deviceItem.printObjects)
                                            object_delete_canvas.excludedObjects = deviceItem.excludedObjects
                                            object_delete_canvas.repaintCanvas()
                                        }
                                    }
                                ...
                                RowLayout{
                                    ...
                                    Rectangle{
                                        ...
                                        MouseArea{
                                            anchors.fill:parent
                                            onClicked: {
                                                idRackBox.checked = true;
                                                deviceItem.materialBoxList.getMaterialSelected(-1,-1)
                                            }
                                        }
                                        onCheckedChanged:{
                                            if(checked){
                                                idRackBox.border.width = 2
                                                idRackBox.border.color = "#17CC5F"
                                            }else{
                                                idRackBox.border.width = 1
                                                idRackBox.border.color = Constants.currentTheme?"#D6D6DC": "#515157"
                                            }
                                        }
                                        ColumnLayout{
                                            anchors.fill:parent
                                            ...
                                            Rectangle{
                                                id:materialBox
                                                Layout.preferredWidth: 57* screenScaleFactor
                                                Layout.preferredHeight: 57* screenScaleFactor
                                                radius:height/2
                                                color: "#505156"
                                                border.width:2
                                                border.color: "#686870"
                                                Layout.topMargin: 17* screenScaleFactor
                                                Layout.alignment: Qt.AlignHCenter
                                                Rectangle{
                                                    id: idRack
                                                ...
                                                Text {
                                                    visible:!deviceItem.materialBoxList.type
                                                    font.weight: Font.Bold
                                                    font.family: Constants.mySystemFont.name
                                                    font.pointSize: Constants.labelFontPointSize_12
                                                    color: sourceTheme.text_normal_color
                                            ...
                                            Canvas {
                                                id: checkCan
                                                Layout.topMargin: 4* screenScaleFactor
                                                Layout.alignment: Qt.AlignHCenter
                                            ...
                                            Text {
                                                ...
                                                font.pointSize: Constants.labelFontPointSize_9
                                                horizontalAlignment: Text.AlignHCenter
                                                Layout.topMargin: checkCan ? 6* screenScaleFactor : 18* screenScaleFactor
                                                Layout.alignment: Qt.AlignHCenter
                                                color: sourceTheme.text_normal_color
                                            ...
                                            Image{
                                                ...
                                                Layout.alignment: Qt.AlignHCenter
                                                Layout.preferredWidth: 21* screenScaleFactor
                                    ...
                                    Rectangle{
                                        ...
                                        onCurGroupChanged:{
                                            humidityId.humidityItem = deviceItem.materialBoxList.getGroupHumidityItem(curGroup)
                                        }
                                        ColumnLayout{
                                            ...
                                            RowLayout{
                                                ...
                                                spacing:10 * screenScaleFactor
                                                Layout.alignment:Qt.AlignRight
                                                property var humidityItem: deviceItem.materialBoxList.getGroupHumidityItem(0)
                                                property var humidity:humidityItem.humidity
                                        ...
                                        Rectangle{
                                            ...
                                            Image{
                                                ...
                                                source:deviceItem.machinePlatformMotionEnable?noBoxPrinter:noBoxPrinter2
                                                anchors.left:parent.left
                                                anchors.leftMargin:12*screenScaleFactor
                                                anchors.top:parent.top
                                                anchors.topMargin:53*screenScaleFactor

                                            }
                                            Text {
                                                anchors.left:parent.left
                                                anchors.leftMargin:165 * screenScaleFactor
                                                anchors.top:parent.top
                                                anchors.topMargin:19*screenScaleFactor
                                                height:66*screenScaleFactor
                                                width:191*screenScaleFactor
                                                font.weight: Font.Bold
                                                font.family: Constants.mySystemFont.name
                                                font.pointSize: Constants.labelFontPointSize_9
                                                color: "#999999"
...
//                                    anchors.topMargin:10* screenScaleFactor
                                ...
                                RowLayout{
                                    ...
                                    BasicDialogButton {
                                        ...
                                        btnRadius:5*screenScaleFactor
                                        btnBorderW:0
                                        enabled:(deviceItem.feedState==0||deviceItem.feedState==3||deviceItem.feedState==14)&&!root.isPrinting && deviceItem.materialBoxList.materialState !== 0
                                        ...
                                        Rectangle {
                                            ...
                                            function specifyPcNozzleDstTemp() {
                                                if(ipAddress !== "")
                                                {
                                                    ...
                                                    __nozzleDstTempDelayShow.start()
                                                    if(boxValue == "") {
                                                        __editNozzle2DstTempBox.text = ""+minValue
                                                    }
                                ...
                                RowLayout {
                                    ...
                                    RowLayout {
                                        ...
                                        Rectangle {
                                            ...
                                            property int minValue: 0
                                            property int maxValue: deviceItem?deviceItem.maxBoxTemp? deviceItem.maxBoxTemp:60: 60
                                            property var delayShow: false
                                            ...
                                            function specifyPcNozzleDstTemp() {
                                                if(ipAddress !== "")
                                                {
                                                    delayShow = true
                                                    __nozzleDstTempDelayShow.start()
                                                    console.warn("boxValue", boxValue)
                                                    if(boxValue == "") boxValue = minValue
                                            ...
                                            TextField {
                                                ...
                                                font.family: Constants.mySystemFont.name
                                                font.pointSize: Constants.labelFontPointSize_9
                                                placeholderText:qsTr("Maximum value")+ __chamberDstTempBox.maxValue
                                                background: null
