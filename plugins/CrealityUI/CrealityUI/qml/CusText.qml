...
Rectangle{
    ...
    property int hAlign: 1 //0： 默认值，字体左对齐 1： 字体居中 2:右对齐
    property alias fontPixelSize: idContentText.font.pixelSize
    ...
    property alias minimumPixelSize: idContentText.minimumPixelSize
