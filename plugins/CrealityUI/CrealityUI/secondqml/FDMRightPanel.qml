...
Rectangle {
    ...
    function setLayerGCodesIndex(step) {
        ...
        //start from 1
        idStepCodeview.lineIndex = kernel_slice_model.findViewIndexFromStep(step);
    }
    ...
    CusRoundedBg {
        ...
        Column {
            ...
            Label {
                text: cxTr("Current Machine") + ": " + (kernel_slice_flow.sliceAttain.printerName() ? kernel_slice_flow.sliceAttain.printerName() + "-" + kernel_slice_flow.sliceAttain.nozzleDiameter() + " nozzle" : kernel_parameter_manager.currentMachineObject.name())
                color: "#FFFFFF" //Constants.right_panel_text_default_color
