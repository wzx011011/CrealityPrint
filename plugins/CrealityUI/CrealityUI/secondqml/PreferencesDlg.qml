...
DockItem {
    ...
    height: (Constants.languageType? 300 : 250) *  screenScaleFactor //mac中文字显示差异，需多留空白
        ...
        Row {
            ...
            CusFolderField
            {
                ...
                onClicked:
                {
                    ...
                    fileDialog.folder = Qt.platform.os === "windows"? "file:///":"file://" + text
                    fileDialog.visible = true
                }
                function callbackText(url)
                {
                    text = url.toString()
                    kernel_preference_manager.downloadModelPath = url
                }
            }
        }
    ...
    File.FileDialog {
        ...
        selectExisting:true
        onAccepted: {
            itemObj.callbackText(fileDialog.fileUrl)
        }
        onRejected: {
