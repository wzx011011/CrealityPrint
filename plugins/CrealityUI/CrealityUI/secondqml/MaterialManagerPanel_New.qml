                ...
                ListView {
                    ...
                    delegate: ItemDelegate {
                        ...
                        background: Rectangle {
                            ...
                            color: parent.highlighted ? Constants.themeGreenColor : parent.hovered ? Constants.leftBtnBgColor_hovered : Constants.themeColor
                        }
                ...
                BasicButton {
                    ...
                    onSigButtonClicked: function() {
                        ...
                        receiver.exec = function() {
                            ...
                            kernel_parameter_manager.reloadAffectedMachines(currentMachine, 0, kernel_ui_parameter.focusedMaterialName)
                            receiver.materialListView.model = null
                            receiver.materialListView.model = receiver.currentMachine.materialsModel
