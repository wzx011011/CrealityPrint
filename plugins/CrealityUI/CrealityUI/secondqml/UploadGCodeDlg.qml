...
BasicDialogV4{
    ...
    property int uploadDlgType: 0   //0: gcode, 1: 3mf, 4: cloud
    ...
    property real windowMaxHeight: 730 * screenScaleFactor
    ...
    property bool currentMachineSupportMutilPlate: currentObject.pcPrinterModel.includes("F008") || currentObject.pcPrinterModel.includes("F018") || uploadDlgType == 0
    ...
    signal sigDetailBtnClicked(var printerID, var printerName, var printerType)
    ...
    onVisibleChanged: {
        if (visible) {
            ...
            var materialrow = usedIndexs.length/4 + 1
            if(materialrow>2)
            {
                var maxHeight = windowMaxHeight + 50* screenScaleFactor * (materialrow - 2)
                //console.log("maxHeight:"+maxHeight+"standaloneWindow.height:"+standaloneWindow.height)
                if(maxHeight < (standaloneWindow.height-50* screenScaleFactor))
                {
                    height = maxHeight
                    materialList.height = 50* screenScaleFactor * materialrow
                }else{
                    height = windowMaxHeight
                    materialList.height = 110* screenScaleFactor
                }
            }
            ...
            imgPreview.source = "";
            imgPreview.source = kernel_slice_flow.gcodeThumbnail();
    ...
    Item {
        ...
        RowLayout{
            ...
            visible: uploadProgress !=0 && uploadProgress != 100 && !upload_cloud
            ProgressBar {
                id: idSendProgressBar
                Layout.preferredHeight: 24 * screenScaleFactor
                Layout.preferredWidth: parent.width - 60 * screenScaleFactor
                from: 0
                to: 100
                ...
                contentItem:
                    ...
                    Rectangle {
                        ...
                        width: idSendProgressBar.visualPosition * parent.width
                    ...
                    Text{
                        ...
                        text: uploadProgress<0?qsTranslate("Cpr_ErrorMsg", currentObject.transErrorMessage):uploadProgress + "%"
                        color: uploadProgress<0?"#FF0000":(Constants.currentTheme ? "#333333" : "#CBCBCC")
            ...
            BasicDialogButton {
                id: idCancelBtn
                enabled: uploadProgress>0 || uploadProgress==-3
                anchors.left: idSendProgressBar.right
                Layout.preferredWidth: 60 * screenScaleFactor
                Layout.preferredHeight: 24 * screenScaleFactor
                //enabled: uploadProgress>0
                text: qsTr("Cancel")
                onSigButtonClicked: {
                    console.log("cancel upload")
                    currentObject.cancelUploadFile()
                }
            }
        }
        ...
        Item {
            width: parent.width
            height: parent.height - titleHeight
            anchors.top: idMessageRow.bottom
            ...
            ColumnLayout {
                            ...
                            onTextEdited: {
                                if(root.visible)
                                {
                                    if(uploadDlgType === 0)
                                    {
                                        ...
                                        kernel_slice_flow.set3mfExportName(idGcodeFileName.text)
                                    }
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        visible:(uploadDlgType === 0&&rowCount === 1) || (uploadDlgType === 4&rowCount === 1) || (uploadDlgType === 0&&kernel_slice_flow.isPreviewGCodeFile)
                    ...
                    SwipeView{
                        ...
                        anchors.centerIn: parent
                        clip: true
                        visible:rowCount>1 && (uploadDlgType === 0||uploadDlgType === 4) && !kernel_slice_flow.isPreviewGCodeFile
                    ...
                    Image {
                        id: imgPreview
                        visible:(rowCount==1&&uploadDlgType===0) || (rowCount==1&&uploadDlgType === 4) || (uploadDlgType===0&&kernel_slice_flow.isPreviewGCodeFile)
                ...
                Row{
                    ...
                    ScrollView {
                        id:materialList
                        clip:true
                        visible:!upload_cloud && currentObject&&currentObject.materialBoxList && +currentObject.cfsConnect === 1 && currentObject.materialBoxList.materialCount>0
                        width:674 * screenScaleFactor
                        ...
                        height: {
                            ...
                            return usedIndexs.length <= 4 ? 50 * screenScaleFactor : 110 * screenScaleFactor
                        }
                        ...
                        Grid {
                            ...
                            onVisibleChanged:{
                                if(visible)
                                {
                                    ...
                                    console.log("materialColorFlow.onVisibleChanged")
                                }else{
                                    materialMap.model=null
                                }
                ...
                ColumnLayout{
                    ...
                    Row{
                        ...
                        Text {
                            ...
                            color: "#FD265A"
                            text:{
                                if(!!control.currentText && currentObject.pcPrinterStatus!==1){
                                    return qsTr("The current printer is offline, please connect it before printing")
                                }else if(!!control.currentText && currentObject.pcPrinterStatus===1 && btn.stateDisable){
                                    return qsTr("The current printer is printing and only supports sending Gcode")
                                }else if(!currentMachineSupportMutilPlate && control.count){
                                    return qsTr("The currently selected printer does not support multi-plate printing")
                                }else if(!control.count){
                                    return qsTr("There is currently no device in the LAN, please add one")
                                }else if(root.currentPrinterNotMap && enableCfs.checked){
                                    return qsTr("There are unmapped filament")
                                }else{
                                    return ""
                                }
                            }
                    ...
                    RowLayout {
                        ...
                        ComboBox {
                            ...
                            Layout.preferredWidth:  400 * screenScaleFactor // errorLayout.fatalErrorCode?: 624 * screenScaleFactor
                            Layout.preferredHeight: 30 * screenScaleFactor
                            textRole: "ipAddr"
                            ...
                            onCurrentIndexChanged:{
                                ...
                                uploadProgress = Qt.binding(function() {
                                    return curObject.gCodeTransProgress;
                                });
                            ...
                            contentItem:RowLayout{
                                ...
                                Text {
                                    Layout.preferredWidth: control.width - 100 * screenScaleFactor
                                    leftPadding: 10 * screenScaleFactor
                        ...
                        Button {
                            ...
                            text: qsTr("Details")
                            visible: currentObject ? currentObject.pcPrinterStatus===1 : false && currentObject ? currentObject.errorCode===0 : false
                            background: Rectangle {
                                color: "transparent"
                                width: parent.width
                                height: parent.height
                                Rectangle {
                                    anchors.horizontalCenter: parent.horizontalCenter
                                    anchors.bottom: parent.bottom
                                    width: 50  // Adjust to Text width
                                    height: 2  // Thickness of the underline
                                    color: "#00FF00"  // Color of the underline
                                }


                            }
                            contentItem: Text {
                                text: idDetailBtn.text
                                font: idDetailBtn.font
                                opacity: enabled ? 1.0 : 0.3
                                color: idDetailBtn.down ? "#17a81a" : "#21be2b"
                                horizontalAlignment: Text.AlignHCenter
                                verticalAlignment: Text.AlignVCenter
                                elide: Text.ElideRight
                            }
                            onClicked: {
                                console.log("deviceItem:",currentObject.pcPrinterState)
                                sigDetailBtnClicked(deviceItem.pcPrinterID,deviceItem.deviceName+"_"+deviceItem.pcIpAddr,deviceItem.printerType)
                                //printerListModel.cSourceModel.showPrinterDetail(deviceItem)
                            }
                        }
                    ...
                    RowLayout{
                        ...
                        property var disableCheck:!(currentObject.pcPrinterState ==0 || currentObject.pcPrinterState == 2 || currentObject.pcPrinterState == 3 || currentObject.pcPrinterState == 4)
                        StyleCheckBox{
                        ...
                        RowLayout{
                            ...
                            ColumnLayout{
                                ...
                                Image{
                                    ...
                                    sourceSize: Qt.size(width,height)
                                    source: currentObject.machinePlatformMotionEnable?"qrc:/UI/photo/upload3mf/rackMaterial.png":"qrc:/UI/photo/upload3mf/rackMaterial2.png"
                                }
                            }
                ...
                RowLayout {
                    ...
                    property bool stateDisable: !(currentObject.pcPrinterState ==0 || currentObject.pcPrinterState == 2 || currentObject.pcPrinterState == 3 || currentObject.pcPrinterState == 4)
                    property var errorCode: +printerListModel.cSourceModel.getPinterErrorCode(control.currentText)
                    property var btnDisable: (btn.progress < 100 && btn.progress > 0 || btn.progress==-2) || statusDisable
                    ...
                    ProgressBar {
                        ...
                        background: BasicDialogButton {
                            ...
                            defaultBtnBgColor: Constants.leftToolBtnColor_normal
                            hoveredBtnBgColor: Constants.leftToolBtnColor_hovered
                            enabled: (uploadDlgType == 0? (kernel_slice_flow.slicePreviewListModel.isSliced(singlePlate.currentIndex)||kernel_slice_flow.isPreviewGCodeFile)&&!btn.btnDisable:!btn.btnDisable) && currentMachineSupportMutilPlate&& idDetailBtn.visible
                            onSigButtonClicked: {
                                printerListModel.cSourceModel.setOneSelected(control.currentText);
                    ...
                    ProgressBar {
                        ...
                        background: BasicDialogButton {
                            ...
                            defaultBtnBgColor: Constants.leftToolBtnColor_normal
                            hoveredBtnBgColor: Constants.leftToolBtnColor_hovered
                            enabled: (uploadDlgType == 0?(!btn.btnDisable && !btn.stateDisable && btn.errorCode === 0 && ((!root.currentPrinterNotMap  && kernel_slice_flow.slicePreviewListModel.isSliced(singlePlate.currentIndex))||kernel_slice_flow.isPreviewGCodeFile)):!btn.btnDisable && !btn.stateDisable && btn.errorCode === 0 &&  !root.currentPrinterNotMap) && currentMachineSupportMutilPlate && idDetailBtn.visible
                            onSigButtonClicked: {
