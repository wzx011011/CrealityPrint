...
ColumnLayout {
    ...
    PanelTitle {
        ...
        CusButtonRec{
            ...
            color: "transparent"
            isEnabled: kernel_parameter_manager.isCrealityMachine
            btnImg.source: isEnabled ? (Constants.currentTheme
                               ? "qrc:/UI/photo/rightDrawer/update/sync_light_default.svg"
                               : "qrc:/UI/photo/rightDrawer/update/sync_dark_default.svg") : "qrc:/UI/photo/rightDrawer/update/sync_dark_default.svg"

            toolTipText: isEnabled ? qsTr("Sync Filament"):qsTr("The current model does not support filament synchronization")
            radius: 5
            border.width: isHovered ? 1 : 0
            border.color: isHovered&&isEnabled ? Constants.themeGreenColor : "transparent"
            onClicked: {
    ...
    PanelTitle {
        ...
        CusButtonRec{
            ...
            Layout.minimumWidth: 24 * screenScaleFactor
            Layout.minimumHeight: Layout.minimumWidth
            normalBdColor:Constants.themeGreenColor
            border.width: isHovered ? 1 : 0
            border.color: isHovered&&isEnabled ? Constants.themeGreenColor : "transparent"
            ...
            color: "transparent"
            btnImg.source: isEnabled ?  (Constants.currentTheme ? "qrc:/UI/photo/rightDrawer/update/update_light_default.svg"
                                                  : "qrc:/UI/photo/rightDrawer/update/update_dark_default.svg") : Constants.right_panel_reset_disabled_image
        ...
        CusButtonRec{
            ...
            Layout.minimumHeight: Layout.minimumWidth
            color: "transparent"
            isEnabled: process_combo_box.currnetModelModifyed
            btnImg.source: isEnabled ? (Constants.currentTheme
                               ? "qrc:/UI/photo/rightDrawer/update/save_light_default.svg"
                               : "qrc:/UI/photo/rightDrawer/update/save_dark_default.svg") : Constants.right_panel_save_disabled_image
                ...
                delegate: ItemDelegate {
                    ...
                    contentItem: RowLayout {
                        ...
                        Button {
                            ...
                            onClicked: {
                                var receiver = {}
                                var processName = root.currentMachine.profileObject(model.index).uniqueName()
                                receiver.exec = function() {
                                    ...
                                    kernel_parameter_manager.reloadAffectedMachines(currentMachine, 1, processName)
                                }
