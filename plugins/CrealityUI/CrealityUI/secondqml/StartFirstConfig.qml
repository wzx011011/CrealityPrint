...
Window {
    ...
    property string shadowColor: Constants.currentTheme ==1 ? "#BBBBBB" : "#333333"
    property string borderColor: Constants.currentTheme ==1 ? "#D6D6DC" : "#262626"
    property string titleFtColor: Constants.currentTheme ==1 ? "#333333" : "#FFFFFF"
    property string titleBgColor: Constants.currentTheme ==1 ? "#E9E9EF" : "#6E6E73"
    property string backgroundColor: Constants.currentTheme ==1 ? "#FFFFFF" : "#4B4B4D"
    signal sigClose()
    ...
    function saveAndFinishConfig() {
        ...
        kernel_global_const.UpdateEnginePathPrefix();
        root.visible = false
        sigClose()
    }
    ...
    Rectangle {
        ...
        Item {
            ...
            Column {
                ...
                Row {
                    ...
                    Text {
                        ...
                        font.family: Constants.mySystemFont.name
                        font.pointSize: Constants.labelFontPointSize_9
                        color: Constants.currentTheme==1 ? "#333333" : "#CBCBCC"
                    }
                    ...
                    ComboBox {
                        ...
                        delegate: ItemDelegate {
                            ...
                            contentItem: Rectangle {
                                anchors.fill: parent
                                color: (idLanguageComboBox.highlightedIndex == index) ? Constants.themeGreenColor : "transparent"
                        ...
                        contentItem: Text {
                            ...
                            verticalAlignment: Text.AlignVCenter
                            elide: Text.ElideRight
                            color: Constants.currentTheme==1 ? "#333333" : "#FFFFFF"
                            text: idLanguageComboBox.displayText
                        }

                        background: Rectangle {
                            color: Constants.currentTheme==1 ? "#FFFFFF" : "#4B4B4D"
                            border.color: Constants.currentTheme==1 ? "#D6D6DC" : "#6E6E72"
                            border.width: 1
                        }
                ...
                Row {
                    ...
                    ComboBox {
                        ...
                        delegate: ItemDelegate {
                            ...
                            contentItem: Rectangle {
                                anchors.fill: parent
                                color: (idServerComboBox.highlightedIndex == index) ? Constants.themeGreenColor : "transparent"
            ...
            Button {
                ...
                background: Rectangle {
                    border.width: 1
                    border.color: Constants.currentTheme==1 ? "#D6D6DC" : "transparent"
                    color: parent.hovered ? (Constants.currentTheme==1 ? "#E8E8ED" : "#59595D") : (Constants.currentTheme==1 ? "#FFFFFF" : "#6E6E73")
                    radius: height / 2
                }
                ...
                contentItem: Text
                {
                    ...
                    font.family: Constants.mySystemFont.name
                    font.pointSize: Constants.labelFontPointSize_9
                    color: Constants.currentTheme==1 ? "#333333" : "#DBDBDC"
                }
