...
Loader {
    ...
    function requestDialog(name) {
        ...
        }else if(name = "open3MFWarningDialog")
        {
            sourceComponent = idOpen3MFWarningDialog;
        }
    ...
    Component {
        id: idOpen3MFWarningDialog

        UploadMessageDlg {
            msgText: qsTr("Reminder: The currently opened 3mf project file has unofficial parameter presets. Please check before slicing!")
            cancelBtnVisible: false
            visible: false
        }
...
//                project_kernel.cancelSave()
    ...
    Component {
        ...
        ProjectComformDlg {
            ...
            Component.onCompleted: {
                receiver = idAllMenuDialog.receiver;
                supportGeometry = receiver.getSupportGeometry();
            }
        }
    }
    Component {
