...
Cx3dWriter::Cx3dWriter(QString path,qtuser_core::Progressor* progressor,QObject *parent) : m_progress(progressor),QObject(parent)
{
...
//   QString strProfilesPath = QStandardPaths::writableLocation(QStandardPaths::AppDataLocation) + "/Profiles";
//   QString currentMachine = SlicerManager::instance().getCurrentMachine();
//   QString currentProfile = ProfileManager::instance().getcurrentProfileName();
//
//   QString oldMachinePathName = strMachinesPath +"/"+ currentMachine+".default";
//   QFile file(oldMachinePathName);
//   if (file.open(QIODevice::ReadOnly | QIODevice::Text))
//   {
//       QByteArray bytes = file.readAll();
//       file.close();
//
//       QString strPathName = strPath + "/" + currentMachine;
//       QString strMachineTemp = currentMachine;
//       QString strName = strMachineTemp.replace("_CX3D","") + "_CX3D.default";
//       if (m_pModelFile->open(QIODevice::WriteOnly, QuaZipNewInfo(strName, strPathName)))
//       {
//           m_pModelFile->write(bytes);
//       }
//       m_pModelFile->close();
//       m_contentxml.machine = strName;
//   }
//
//   QString oldProfilePathName = strProfilesPath + "/"+ currentMachine + "/"+ currentProfile+".default";
//   file.setFileName(oldProfilePathName);
//   
//   if (file.open(QIODevice::ReadOnly | QIODevice::Text))
//   {
//       QByteArray bytes = file.readAll();
//       file.close();
//
//       QString strPathName = strPath + "/" + currentProfile;
//       QString name = currentProfile + ".default";
//       if (m_pModelFile->open(QIODevice::WriteOnly, QuaZipNewInfo(name, strPathName)))
//       {
//           m_pModelFile->write(bytes);
//       }
//       m_pModelFile->close();
...
void Cx3dWriter::saveProfile(QString strPath)
{
    ...
    saveSettings(strName, strMachinesPath + "/" + strName);
    saveSettings(name, strProfilesPath + "/" + currentMachine + "/" + name);
