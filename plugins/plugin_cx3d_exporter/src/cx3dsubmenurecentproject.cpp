...
Cx3dSubmenuRecentProject *Cx3dSubmenuRecentProject:: getInstance()
{
    ...
    {
        m_instance = new Cx3dSubmenuRecentProject();
    }
    return m_instance;
}
...
void Cx3dSubmenuRecentProject::slotLanguageChanged()
{
    m_actionname = tr("Recently Opened Project");
}
...
void Cx3dSubmenuRecentProject::initActionModel()
{
    ...
    Cx3dClearProjectCommand *clear = new Cx3dClearProjectCommand();
...
void Cx3dSubmenuRecentProject::updateRecentFiles(QSettings &settings)
{
    ...
    {
        Cx3dRecentProjectCommand *p = new Cx3dRecentProjectCommand();
        p->setName(var);
