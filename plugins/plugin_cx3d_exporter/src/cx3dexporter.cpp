...
{
    m_exportcommand = new CX3DExporterCommand();
    ...
    //    p->CreateOpenProject();
    Cx3dSubmenuRecentProject* rectfile= Cx3dSubmenuRecentProject::getInstance();
    ...
    Cx3dAutoSaveProject::instance()->createOpenProject();
}
...
{
    QString strLocalPath = QStandardPaths::writableLocation(QStandardPaths::AppDataLocation);
    QSettings setting;
