# IF (CMAKE_BUILD_TYPE MATCHES "Release")
	set(DESKTOP_LINK_NAME "E-Tech Slicer")
	...
	SET(PROJECT_ICONS_DIRECTORY "${CMAKE_SOURCE_DIR}/customized/E-Tech/icon")
  ...
  ENDIF()
		...
		LIST(APPEND CPACK_NSIS_EXTRA_INSTALL_COMMANDS "CreateDirectory $APPDATA\\\\COBICON")
		LIST(APPEND CPACK_NSIS_EXTRA_INSTALL_COMMANDS "CreateDirectory $APPDATA\\\\COBICON\\\\${PROJECT_NAME}")
		LIST(APPEND CPACK_NSIS_EXTRA_INSTALL_COMMANDS "CreateDirectory $APPDATA\\\\COBICON\\\\${PROJECT_NAME}\\\\resources")
	...
	ELSEIF(CC_BC_MAC)
		include(${CMAKE_SOURCE_DIR}/customized/E-Tech/macx.cmake)
	ELSEIF(CC_BC_LINUX)
	ENDIF()
